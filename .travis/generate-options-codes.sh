...
get_options() {
  ...
  echo $'{% hint style="warn" %}' >> ${optionsFile}
  echo $'Do **not** manually edit this document. It is programatically generated by [generate-options-codes.sh](https://github.com/joeblau/teslaapi.io/blob/master/.travis/generate-options-codes.sh).' >> ${optionsFile}
  echo $'{% endhint %}\n' >> ${optionsFile}
