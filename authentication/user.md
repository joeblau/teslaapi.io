...
{% api-method method="get" host="https://owner-api.teslamotors.com" path="/api/1/users/onboarding\_data" %}
{% api-method-summary %}
Onboarding Data
{% endapi-method-summary %}
...
{% api-method method="post" host="https://owner-api.teslamotors.com" path="/api/1/users/keys" %}
{% api-method-summary %}
Send Device Key
{% endapi-method-summary %}
